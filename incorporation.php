...
<body>
  ...
  <section class="banner-section">
    ...
    <div class="banner-image" style="background-image:url('./img/bg_incorporation.jpg');opacity:1"></div>
    <div class="banner-text">
      Incorporation
    </div>
  </section>
  <section class="entity">
    <div class="subtitle"><span class="tag">3</span>Types of entity Entities</div>
    <div class="reason left">
      <div class="reason-inner">
        <div class="image">
          <div class="image-inner">
            <img src="img/bg_BE_Type1.jpg" alt="">
          </div>
        </div>
      <div class="text">
    ...
    <div class="reason right">
      <div class="reason-inner">
        <div class="image">
          <div class="image-inner">
            <img src="img/bg_BE_Type2.jpg" alt="">
          </div>
        </div>
        <div class="text">
          <div class="text-inner">
    ...
    <div class="reason left">
      <div class="reason-inner">
        <div class="image">
          <div class="image-inner">
            <img src="img/bg_BE_Type3.jpg" alt="">
          </div>
        </div>
        <div class="text">
          <div class="text-inner">
  ...
  <section class="registration">
    <div class="subtitle">General Business Registration Process</div>
    <div class="regis-process">
        ...
        <div class="process-text">Apply for reservation of company name and business scope (Enterprise: Central Region Office, MOEA / Business firms: Local city or county government).
          <font style="font-weight:bold"><a href="https://onestop.nat.gov.tw/oss/web/Show/engWorkFlow.do;jsessionid=4feae3d194dd2050198e2a22b7c6">Click Here</a> for online application</font>
        </div>
        ...
        <div class="process-text">Regarding Taxation Registration、Export/Import Business Registration, Factory Registration, and Application for Businesses Requiring Special Permission,
          <font style="font-weight:bold">please refers to <a href="https://investtaiwan.nat.gov.tw/showPagengInvestmentStatus02?lang=eng&search=InvestmentStatus02">Invest Taiwan Website</a>.</font>
        </div>
    </div>
  </section>
